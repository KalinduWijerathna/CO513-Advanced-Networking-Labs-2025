...
try:
    ...
    latency_csv = os.path.join(LOG_DIR, "latency_data_token_bucket.csv")
    ...
    summary_csv = os.path.join(LOG_DIR, "summary_stats_token_bucket.csv")
    ...
    plt.grid(True)
    plt.tight_layout()
    latency_plot_path = os.path.join(PLOT_DIR, "latency_plot_h264_token_bucket.png")
    ...
    plt.tight_layout()
    loss_plot_path = os.path.join(PLOT_DIR, "frame_loss_plot_h264_token_bucket.png")
